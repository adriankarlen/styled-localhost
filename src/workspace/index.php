...
<body>
    <div class="wrapper">
        <div class="projekte">
            <a href="http://localhost/personal/" class="projekte-link">
                <i class="fas fa-laptop-house image-navbar"></i>
                <span class="tooltip">Side Projects</span>
            </a>
            <a href="http://localhost/workspace/" class="projekte-link active">
            ...
            <ul class="list">
                ...
                function scan_dir($dir_lm)
                {
                    ...
                    foreach (scandir($dir_lm) as $file) {
                        ...
                        if (file_exists($dir_lm . '/' . $file . '/docroot')) {
                            $files[$file] = filemtime($dir_lm . '/' . $file . '/docroot');
                        } else {
                ...
                <?php foreach ($dir as $file) : ?>
                    ...
                    <?php if ($file != "." && $file != ".." && $file != "index.php") : ?>
                        ...
                        <li class="list-item">
                            <a class="link" href="<?php echo $file; ?>/docroot"><?php echo $file; ?></a>
